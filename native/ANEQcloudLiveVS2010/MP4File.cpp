...
MP4File::MP4File(std::wstring filePath, UINT32 fps, UINT32 videoWidth, UINT32 videoHeight) :
	m_hDC(NULL),
	m_pSinkWriter(NULL),
	...
	m_inputEncoding(MFVideoFormat_RGB32),//MFVideoFormat_ARGB32	MFVideoFormat_RGB32
